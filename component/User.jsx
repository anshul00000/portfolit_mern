...
{/* Conditional Follow button */}
{
  // followStatus[project.owner._id] ? (
    ...
    ifol && ifoli ? (
      ...
      <p style={{display : "inline"}} onClick={my_fun_2}>Following ✔️ <Follow my_id={user_._id} back={false} un_follow={true} /></p>
      ...
      <p style={{display : "inline"}} onClick={my_fun_2}><Follow my_id={user_._id} back={false} un_follow={true} /></p>
